...
<section class="section" id="introduce">
    <div class="section-background bg">
        <div class="image background-image-loaded image-loaded" style="background-image: url(&quot;/images/contacto.jpg&quot;);"> <img src="/images/contacto.jpg" alt="El Silencio"></div>
    </div>
    <div class="section-video">
        <div class="flowplayer is-mouseout fp-default-playlist is-muted is-ready is-playing has-title is-live-position" data-m3u8="//cdn.flowplayer.org/328646/421744.m3u8" data-mp4="//cdn.flowplayer.org/328646/421744-720p.mp4" id="player" data-flowplayer-instance-id="0">
            <div class="fp-ratio" style="padding-top: 41.6667%;"></div>
            <div class="fp-player">
                <video src="https://cdn.flowplayer.org/328646/421744-720p.mp4" class="fp-engine " autoplay="" preload="true" webkit-playsinline="true" playsinline="true" loop="" x-webkit-airplay="allow"></video>
                <div class="fp-ui">
                    ...
                    <div class="fp-play">
                        ...
                        <svg class="fp-play-rounded-fill" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                            ...
                            <path class="b" d="M35.942,35.2323c0-4.7289,3.3506-6.6637,7.446-4.2971L68.83,45.6235c4.0956,2.364,4.0956,6.2319,0,8.5977L43.388,68.91c-4.0954,2.364-7.446.43-7.446-4.2979Z" filter="url(/contacto#f1)"></path>
                        </svg>
                        ...
                        <svg class="fp-play-rounded-outline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 99.844 99.8434">
                            ...
                            <path class="fp-color-play" d="M49.9217-.078a50,50,0,1,0,50,50A50.0564,50.0564,0,0,0,49.9217-.078Z"></path>
                            <path class="controlbutton" d="M41.0359,71.19a5.0492,5.0492,0,0,1-2.5575-.6673c-1.8031-1.041-2.7958-3.1248-2.7958-5.8664V35.1887c0-2.7429.9933-4.8272,2.797-5.8676,1.8025-1.0422,4.1034-.86,6.48.5143L70.4782,44.5672c2.3751,1.3711,3.6826,3.2725,3.6832,5.3545s-1.3076,3.9845-3.6832,5.3562L44.9592,70.0114A7.9384,7.9384,0,0,1,41.0359,71.19Zm.0065-40.123a2.6794,2.6794,0,0,0-1.3582.3413c-1.0263.5926-1.5912,1.9349-1.5912,3.78V64.6563c0,1.8449.5649,3.1866,1.5906,3.7791,1.0281.5932,2.4733.4108,4.07-.512L69.273,53.1906c1.5983-.9227,2.478-2.0838,2.478-3.2689s-.88-2.3445-2.478-3.2666L43.754,31.9227A5.5685,5.5685,0,0,0,41.0423,31.0671Z" filter="url(/contacto#f1)"></path>
                        </svg>
                        <svg class="fp-play-sharp-fill" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                            ...
                            <path class="fp-color-play" d="M49.9217-.078a50,50,0,1,0,50,50A50.0564,50.0564,0,0,0,49.9217-.078Z"></path>
                            <polygon class="controlbutton" points="73.601 50 37.968 70.573 37.968 29.427 73.601 50" filter="url(/contacto#f1)"></polygon>
                        </svg>
                        <svg class="fp-play-sharp-outline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 99.844 99.8434">
                            ...
                            <path class="fp-color-play" d="M49.9217-.078a50,50,0,1,0,50,50A50.0564,50.0564,0,0,0,49.9217-.078Z"></path>
                            <path class="controlbutton" d="M36.9443,72.2473V27.2916L75.8776,49.77Zm2.2-41.1455V68.4371L71.4776,49.77Z" filter="url(/contacto#f1)"></path>
                        </svg>
                    </div>
                    <div class="fp-pause">
                        <a class="fp-icon fp-playbtn"></a>
                        <svg class="fp-pause-sharp-outline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 99.8434 99.8434">
                            ...
                            <g class="controlbutton" filter="url(/contacto#f1)">
                        ...
                        <svg class="fp-pause-rounded-outline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 99.8434 99.8434">
                            ...
                            <g class="controlbutton">
                                <path class="rect" d="M39.0036,71.9726a7.565,7.565,0,0,1-7.557-7.556v-28.99a7.5565,7.5565,0,0,1,15.113,0v28.99A7.5648,7.5648,0,0,1,39.0036,71.9726Zm0-41.904a5.3647,5.3647,0,0,0-5.3593,5.3582v28.99a5.3587,5.3587,0,0,0,10.7174,0v-28.99A5.3645,5.3645,0,0,0,39.0036,30.0686Z" filter="url(/contacto#f1)"></path>
                                <path class="rect" d="M60.84,71.9726a7.5648,7.5648,0,0,1-7.556-7.556v-28.99a7.5565,7.5565,0,0,1,15.113,0v28.99A7.565,7.565,0,0,1,60.84,71.9726Zm0-41.904a5.3645,5.3645,0,0,0-5.3582,5.3582v28.99a5.3587,5.3587,0,0,0,10.7174,0v-28.99A5.3647,5.3647,0,0,0,60.84,30.0686Z" filter="url(/contacto#f1)"></path>
                            </g>
                        </svg>
                    ...
                    <div class="fp-controls">
                        <a class="fp-icon fp-playbtn"></a> <span class="fp-elapsed">00:13</span>
                        <div class="fp-timeline fp-bar">
                            <div class="fp-buffer" style="width: 100%;"></div> <span class="fp-timestamp"></span>
                            <div class="fp-progress fp-color animated" style="transition-duration: 250ms; width: 60.2%;"></div>
                        </div> <span class="fp-duration">00:22</span> <span class="fp-remaining">00:09</span>
                        <div class="fp-volume">
    ...
    <div class="section-content is-large">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="title-box">
                        <h1 class="line">Contacto</h1>
                        <div class="paragraph">
                            <p>Si tienes comentarios, opiniones, reclamos, felicitaciones, sugerencia o quieres establecer un contacto comercial con nosotros utiliza este formulario para enviar tu mensaje.</p>
                        </div>
                    </div>
                </div>
            </div>
